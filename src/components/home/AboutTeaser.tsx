    ...
    return (
        <section id="about" className="bg-black text-white w-full pb-20">
            <div className="pb-10 md:pb-24 xs:-mt-16 md:mt-0">
                <h2 aria-label="About" style={{ fontSize: "clamp(5rem, 10vw, 5rem)", lineHeight: 1, display: "flex", alignItems: "baseline", gap: 0, margin: 0, padding: 0, textTransform: "uppercase", userSelect: "none" }}>
            ...
            <div className="pb-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div className="flex flex-col md:pt-10">
                    ...
                    <div className="flex flex-col justify-between flex-1">
                        <div className="pt-4 pb-8 text-sm md:text-[18px] font-extralight" style={{ fontFamily: "var(--font-body)" }}>
