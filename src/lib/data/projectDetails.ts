...
export const PROJECT_DETAILS: ProjectDetail[] = [
    ...
    },
    {
        ...
        bannerImage: { src: "/images/mavin.webp", alt: " platform banner" },
        featureImage: { src: "/images/mavin-feat.webp", alt: " platform feature" },
        beforeImages: [ 
            { src: "/images/mavin-before.webp", alt: " before 1" },
            { src: "/images/mavin-before2.webp", alt: " before 2" },
        ],
        gridImages: [
            { src: "/images/mavin-grid.webp", alt: " grid image 1" },
            { src: "/images/mavin-grid2.webp", alt: " grid image 2" },
            { src: "/images/mavin-grid3.webp", alt: " grid image 3" }
        ],
        credits: [
            { role: "", name: "" },
            { role: "", name: "" },
