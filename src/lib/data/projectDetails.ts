...
export const PROJECT_DETAILS: ProjectDetail[] = [
    ...
    },
    {
        ...
        result: [
            { text: "The final KDNNN platform successfully provided users with a comprehensive and personalized news experience." },
            { heading: "Clean Interface", text: "A clean and intuitive interface that allowed users to easily navigate through different news categories and topics." },
            { heading: "Personalized Feed", text: "Users could customize their news feed based on their interests, ensuring they received relevant content." },
            { heading: "Interactive Features", text: "Commenting, sharing, and saving articles for later reading helped foster a sense of community and engagement among users." },
        ],
