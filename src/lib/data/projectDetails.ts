...
export const PROJECT_DETAILS: ProjectDetail[] = [
    ...
    },
    {
        ...
        problem: "",
        result: "",
        bannerImage: { src: "/images/kdn-tall2.webp", alt: " platform banner" },
        featureImage: { src: "/images/kdn.webp", alt: " platform feature" },
        beforeImages: [ 
            { src: "/images/kdn-before2.webp", alt: " before 1" },
            { src: "/images/kdn-before4.webp", alt: " before 2" },
        ],
        gridImages: [
            { src: "/images/kdn-before1.webp", alt: " grid image 1" },
