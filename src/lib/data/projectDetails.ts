...
export const PROJECT_DETAILS: ProjectDetail[] = [
    {
        ...
        featureImage: {
            src: "/images/astra4.png",
            alt: "Astra platform feature",
        },
        beforeImages: [ 
            { src: "/images/astra-before.png", alt: "Astra before 1" },
            { src: "/images/astra-before2.png", alt: "Astra before 2" },
        ],
        gridImages: [
            { src: "/images/astra-feature.png", alt: "Astra grid image 1" },
            { src: "/images/astra-tall2.png", alt: "Astra grid image 3" },
            { src: "/images/astra-tall.png", alt: "Astra grid image 2" },
        ],
        credits: [
    ...
    },
    {
        ...
        featureImage: { src: "/images/triskelion3.png", alt: " platform feature" },
        beforeImages: [ 
            { src: "/images/triskelion4.png", alt: " before 1" },
            { src: "/images/triskelion6.png", alt: " before 2" },
        ],
        gridImages: [
            { src: "/images/triskelion5.png", alt: " grid image 1" },
    ...
    },
    {
        ...
        featureImage: { src: "/images/solbase-feat.png", alt: "Solbase platform feature" },
        beforeImages: [ 
            { src: "/images/solbase-work2.webp", alt: " before 1" },
            { src: "/images/before2.png", alt: " before 2" },
        ],
        gridImages: [
            { src: "/images/solbase-grid1.png", alt: " grid image 1" },
            { src: "/images/solbase-grid-2.png", alt: " grid image 2" },
    ...
    },
    {
        ...
        featureImage: { src: "/images/focus-feat.png", alt: " platform feature" },
        beforeImages: [ 
            { src: "/images/focus-before1.png", alt: " before 1" },
            { src: "/images/focus-work2.webp", alt: " before 2" },
        ],
        gridImages: [
            { src: "/images/focus-grid1.png", alt: " grid image 1" },
            { src: "/images/focus-grid2.png", alt: " grid image 2" },
    ...
    },
    {
        ...
        featureImage: { src: "/images/toch-feat.png", alt: " platform feature" },
        beforeImages: [ 
            { src: "/images/Group 161.png", alt: " before 1" },
            { src: "/images/Group 162.png", alt: " before 2" },
        ],
        gridImages: [
            { src: "/images/", alt: " grid image 1" },
            { src: "/images/toch-before.png", alt: " grid image 2" },
            { src: "/images/toch-before2.png", alt: " grid image 3" },
        ],
        credits: [
            { role: "", name: "" },
            { role: "", name: "" },
    ...
    },
    {
        ...
        featureImage: { src: "/images/revo-feat.png", alt: " platform feature" },
        beforeImages: [ 
            { src: "/images/revolt-1.png", alt: " before 1" },
            { src: "/images/revo-before.png", alt: " before 2" },
        ],
        gridImages: [
            { src: "/images/", alt: " grid image 1" },
            { src: "/images/revo-grid.png", alt: " grid image 2" },
            { src: "/images/revolt-2.png", alt: " grid image 3" }
        ],
        credits: [
            { role: "", name: "" },
            { role: "", name: "" },
    ...
    },
    {
        ...
        tagline: "A website for news and broadcast information",
        howItStarted: "",
        problem: "",
        result: "",
        bannerImage: { src: "/images/kdn-tall2.png", alt: " platform banner" },
        featureImage: { src: "/images/kdn.png", alt: " platform feature" },
        beforeImages: [ 
            { src: "/images/kdn-before2.png", alt: " before 1" },
            { src: "/images/kdn-before4.png", alt: " before 2" },
        ],
        gridImages: [
            { src: "/images/kdn-before1.png", alt: " grid image 1" },
            { src: "/images/", alt: " grid image 2" },
            { src: "/images/", alt: " grid image 3" },
            { src: "/images/", alt: " grid image 4" },
        ],
        credits: [
            { role: "Designer", name: "Morewa " },
        ],
        nextProject: "",
    },
    {
        ...
        problem: "",
        result: "",
        bannerImage: { src: "/images/", alt: " platform banner" },
        featureImage: { src: "/images/as", alt: " platform feature" },
        beforeImages: [ 
            { src: "/images/", alt: " before 1" },
            { src: "/images/", alt: " before 2" },
        ],
        gridImages: [
            { src: "/images/", alt: " grid image 1" },
            { src: "/images/", alt: " grid image 2" },
    ...
    },
    {
        ...
        problem: "",
        result: "",
        bannerImage: { src: "/images/", alt: "Astra platform banner" },
        featureImage: { src: "/images/as", alt: "Astra platform feature" },
        beforeImages: [ 
            { src: "/images/", alt: " before 1" },
            { src: "/images/", alt: " before 2" },
        ],
